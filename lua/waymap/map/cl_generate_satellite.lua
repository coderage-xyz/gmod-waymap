...
Waymap.Map.generators[Waymap.Map.MODE.SATELLITE] = function(camera, callback)
	...
	local texture = GetRenderTargetEx("Waymap.Map.GenerateSatallite", width, height, RT_SIZE_DEFAULT, MATERIAL_RT_DEPTH_SHARED, 1, CREATERENDERTARGETFLAGS_UNFILTERABLE_OK, IMAGE_FORMAT_DEFAULT)

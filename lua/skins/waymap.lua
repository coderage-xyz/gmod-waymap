...
SKIN.PrintName = "Waymap Derma Skin"
SKIN.Author = "piqey"
SKIN.DermaVersion = 1
SKIN.GwenTexture = Material( "gwenskin/waymap.png" )
...
derma.DefineSkin( "Waymap", "Default Garry's Mod skin with a gradient map overlay.", SKIN )
